...
/* ── Hero ── */
.ym-hero{max-width:900px;margin:0 auto 2rem;padding:1.6rem 1.2rem 1.8rem;border-radius:24px;text-align:center;background:#f8fafc;box-shadow:0 24px 48px rgba(0,0,0,.08),inset 0 1px 0 rgba(255,255,255,.9)}
@media(prefers-color-scheme:dark){.ym-hero{background:#1e293b;box-shadow:0 28px 56px rgba(0,0,0,.45),inset 0 1px 0 rgba(255,255,255,.06)}}
.ym-hero h1{font-size:1.9rem;font-weight:700;color:#0f172a;margin:0 0 .3rem}
@media(prefers-color-scheme:dark){.ym-hero h1{color:#f8fafc}}
.ym-hero .sub{font-size:.92rem;color:#475569;margin:0 0 .6rem}
.ym-hero .tm{font-size:.88rem;color:#64748b;margin:0 0 1.4rem}
@media(prefers-color-scheme:dark){.ym-hero .sub,.ym-hero .tm{color:rgba(248,250,252,.65)}}
.ym-nav{display:flex;justify-content:center;gap:12px;flex-wrap:wrap}
.ym-nav-btn{padding:9px 20px;border-radius:999px;border:1px solid #dbe3ff;background:#fff;font-size:13px;cursor:pointer;color:#3b5bfd;box-shadow:0 6px 16px rgba(59,91,253,.12),inset 0 1px 0 rgba(255,255,255,.9);transition:transform .15s ease,box-shadow .15s ease}
.ym-nav-btn:hover{transform:translateY(-1px);box-shadow:0 10px 22px rgba(59,91,253,.18),inset 0 1px 0 rgba(255,255,255,.9)}
.ym-nav-btn.active{background:linear-gradient(180deg,#5b7cfa,#3b5bfd);color:#fff;border-color:transparent;box-shadow:0 12px 28px rgba(59,91,253,.45),inset 0 1px 0 rgba(255,255,255,.35)}
@media(prefers-color-scheme:dark){.ym-nav-btn{background:#020617;color:#93c5fd;border-color:rgba(147,197,253,.35);box-shadow:0 8px 20px rgba(0,0,0,.6),inset 0 1px 0 rgba(255,255,255,.06)}}
...
/* ── Roster ── */
.wr-root{width:100%;max-width:1200px;margin:1rem auto;padding:0;overflow-x:hidden;font-family:system-ui,"PingFang SC","Microsoft YaHei";color:var(--ym-ink)}
.wr-tabs{display:flex;justify-content:center;gap:8px;flex-wrap:wrap;padding:10px;border-radius:999px;background:var(--ym-soft);border:1px solid var(--ym-border);margin-bottom:12px}
.wr-tab{padding:7px 16px;border-radius:999px;font-size:13px;cursor:pointer;text-decoration:none;user-select:none;background:var(--ym-card);color:var(--ym-ink);border:1px solid var(--ym-border);transition:.2s ease}
.wr-tab:hover{transform:translateY(-1px)}
.wr-tab.active{background:linear-gradient(180deg,#4f86ff,#2b66f6);color:#fff;border-color:transparent}
.wr-card{width:100%;padding:14px;border-radius:18px;background:linear-gradient(180deg,var(--ym-card),var(--ym-soft));border:1px solid var(--ym-border);overflow:hidden}
.wr-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:4px}
...
.wr-group{margin-top:18px}.wr-group h3{margin:0 0 8px;font-size:14px;color:var(--ym-ink2)}
.wr-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:10px}
@media(max-width:520px){.wr-grid{grid-template-columns:repeat(2,1fr)}}
.wr-section{background:rgba(0,0,0,.12);border-radius:12px;padding:10px;border:1px solid var(--ym-border)}
@media(prefers-color-scheme:light){.wr-section{background:rgba(0,0,0,.04)}}
...
.wr-name input{flex:1;min-width:0;padding:5px 7px;border-radius:7px;border:none;background:var(--ym-soft);color:var(--ym-ink);font-size:13px}
.wr-name input::placeholder{color:var(--ym-ink3)}
.wr-name button{background:#ef4444;border:none;border-radius:6px;color:#fff;cursor:pointer;padding:0 7px;font-size:13px}
.add-btn{margin-top:5px;font-size:11px;cursor:pointer;color:#7aa2ff}
...
.ym-song-tab.active{background:linear-gradient(160deg,#5b7cfa,#3b5bfd);color:#fff;border-color:transparent;box-shadow:0 8px 20px rgba(59,91,253,.35)}
@media(prefers-color-scheme:dark){.ym-song-tab{background:rgba(255,255,255,.06);border-color:rgba(255,255,255,.12)}.ym-song-tab:hover{background:rgba(255,255,255,.1)}}
