...
.wr-card{width:100%;padding:14px;border-radius:18px;background:linear-gradient(180deg,var(--ym-card),var(--ym-soft));border:1px solid var(--ym-border);overflow:visible}
...
@media(max-width:520px){.wr-grid{grid-template-columns:1fr 1fr}}@media(max-width:380px){.wr-grid{grid-template-columns:1fr}}
.wr-section{background:var(--ym-soft);border-radius:12px;padding:10px;border:1px solid var(--ym-border)}
