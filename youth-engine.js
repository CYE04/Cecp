...
/* ── Roster ── */
.wr-root{width:100%;margin:1rem 0;padding:0;box-sizing:border-box;font-family:system-ui,"PingFang SC","Microsoft YaHei";color:var(--ym-ink)}
...
.wr-card{width:100%;padding:14px;border-radius:18px;background:linear-gradient(180deg,var(--ym-card),var(--ym-soft));border:1px solid var(--ym-border);box-sizing:border-box}
...
.wr-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:10px}
